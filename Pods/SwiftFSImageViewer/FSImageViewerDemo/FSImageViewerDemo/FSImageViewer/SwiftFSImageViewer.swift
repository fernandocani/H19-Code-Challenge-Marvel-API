...
//    let x = scrollView.center.x
//    let y = scrollView.center.y
//    let w = CGFloat(0.0)
//    let h = CGFloat(0.0)
//    self.originalImageView.frame = CGRectMake(x, y, w, h)//self.contentImageViewNewFrame
    
    self.scrollView.removeFromSuperview()
    
//    UIView.animateWithDuration(0.3) {
//      self.originalImageView.frame = CGRectMake(x, y, w, h)
//    }
  }
